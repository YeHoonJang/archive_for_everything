...
class patentDownload(threading.Thread):
    ...
    #
    # def IsDataDownload(self):
    #     data = self.dataQueue.get()
    #     url_file = urllib.request.urlopen(data)
    #     is_download_question = input("The size of the data which you want to download is %s. "
    #                                  "Continue downloading?"  % url_file)
    #     is_download_answer = is_download_question.upper()
    #     is_download_flag = True
    #
    #     while is_download_flag == True:
    #         if is_download_answer in ["Y", "YES"]:
    #             is_download = True
    #             is_download_flag = False
    #             return is_download
    #
    #         elif is_download_answer in ["N", "NO"]:
    #             is_download = False
    #             is_download_flag = False
    #             return is_download
    #
    ...
    def run(self):
        ...
        url_file = urllib.request.urlopen(url_data)
        is_download_question = input("The size of the data which you want to download is %s. "
                                     "Continue downloading?" % url_file)
        is_download_answer = is_download_question.upper()
        is_download_flag = True
