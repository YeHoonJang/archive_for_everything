...
class TabFragment : Fragment() {
    ...
    */
    var data = arrayOf("우산", "공학용계산기", "실험복")
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var adapter = ArrayAdapter<String>(context, android.R.layout.simple_list_item_1, data)
        lv?.adapter = adapter
...
//        fragment_textView.text = arguments?.getString("title")
//    }
//
