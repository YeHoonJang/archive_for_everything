...
- 비용
  * $3,495
- OS
  * CentOS or Redhat Enterprise Linux v.6, v.7 / Ubuntu
- DB
  * MySQL. MariaDB, PostgresQL

#### 단점
- 수집 데이터를 그래프로 만들 수 없는 경우가 존재 → 다른 툴을 이용
...
- 비용
  * 무료
- OS
  * Linux/Unix, Windows, , FreeBSD, OpenBSD, NetBSD
- DB
  * LevelDB
...
- 비용
  * 견적
- OS
  * Windows, Ubuntu, CentOS, Debian, RedHat, Amazon AM Linux 등
...
- 비용
  * 무료 / 상용지원계약 견적 요청 / 통합, turnkey, 솔루션, 컨설팅 등의 유료 서비스 제공
- OS
...
- 멀티 테넌시 지원
- 비용
  * 제한적인 오픈 소스 버전이며, 풀 버전을 이용하려면 제품 구매가 필요 / 견적
- OS
  * Dell PowerEdge, HP Proliant, IBM Power, Linux, Windows, Solaris, HP-UX, AIX
