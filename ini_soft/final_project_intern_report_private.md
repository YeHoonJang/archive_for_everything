...
~~~
초기의 content 테이블은 count에 관련된 column 이 한 개 이고, count column에 저장 된 숫자가 max count로 적용되었지만, 견고한 프로세스를 위해 'max_count' 와 'min_count' 를 분리
~~~
