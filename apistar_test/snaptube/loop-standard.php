...
?>									
						...
						<div class="post-thumb">
							<div class="post-thumb-img-wrapper">
								<a class="link_image" href="<?php echo get_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'vh'), the_title_attribute('echo=0')); ?>">
									<img src="<?php echo preg_replace('#^https?://#', '//', $img[0]); ?>" alt="">
								</a>
							</div>
							<div class="post-info-box">
								...
								if ( function_exists('snaptube_like_button') ) { ?>
										<div class="vc_post_likes icon-heart"><?php echo snaptube_like_count( $post->ID ); ?></div>
								<?php }; ?>
							</div>
						</div>
						<div class="post-date">
				...
				<?php } else if ( get_post_type() == 'videogallery' && defined('APPTHA_VGALLERY_BASEURL') ) {
						global $wpdb,$post;
							...
							<div class="post-thumb-img-wrapper <?php echo $video_sd_image; ?>">
								<div class="search-img-wrapper">
									<a class="link_image" href="<?php echo get_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'vh'), the_title_attribute('echo=0')); ?>">
										...
										?>
											<img src="<?php echo preg_replace('#^https?://#', '//', $image_file); ?>" alt="">
										<?php } ?>
									</a>
								</div>
							</div>
