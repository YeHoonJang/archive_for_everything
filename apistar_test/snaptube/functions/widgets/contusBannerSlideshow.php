...
function widget_ContusBannerSlideshow_init() {
	...
	{     
		...
		?>
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/jquery-1.3.2.min.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/jquery-ui-1.7.1.custom.min.js"></script>
...
?>
               <iframcontus  type="text/html" width="672" height="315" src="//www.youtube.com/embed/<?php echo $videoid; ?>" frameborder="0">
               </iframcontus>
<?php
                } else { 
                    if ($file_type == 2) {                  ## For uploaded image
                    ...
                    $streamer       = str_replace("rtmp://", "//", $bannerSlideShow[$i]->streamer_path);
...
<?php for ($i = 0; $i < count($bannerSlideShow); $i++) { ?>
				...
				<div class="nav_container">
					...
					<div class="slide_video_info" >
                                <?php echo mb_substr($bannerSlideShow[$i]->name, 0, 25); ?>
                                <div class="category">
	...
	function widget_ContusBannerSlideshow_control()
	{
		...
		// The form fields
		echo '<p >
        <label for="ContusBannerSlideshow-title">' . __('Title:', 'vh') . '
        <input id="ContusBannerSlideshow-title" name="ContusBannerSlideshow-title" type="text" value="'.$title.'" />
        </label></p>';
		echo '<p >
        <label for="ContusBannerSlideshow-show">' . __('Show:', 'vh') . '
