...
class vh_googlemap extends WP_Widget {
	public function __construct() {
		...
		parent::__construct('gmap', __('Snaptube - Google map', 'vh') , $widget_options);
	}
	...
	public function widget($args, $instance) {
		...
		// Load google map JS
		if (!empty($gmap_key)) { ?>
			<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=<?php echo $gmap_key; ?>"></script>
		<?php
