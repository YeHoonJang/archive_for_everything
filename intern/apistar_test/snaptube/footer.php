			...
			<div class="footer-container <?php echo $footer_menu_class; ?> vc_row wpb_row vc_row-fluid">
				...
				<div class="footer-inner vc_col-sm-12">
					...
					<div class="footer_info">
						<a href="<?php echo home_url(); ?>"><img src="<?php echo preg_replace('#^https?://#', '//', $footer_logo); ?>"<?php echo $logo_size_html ; ?> class="<?php echo $retina_logo_class; ?>" alt="<?php bloginfo('name'); ?>" /></a>
