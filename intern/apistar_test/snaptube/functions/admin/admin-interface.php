...
function ajax_callback() {
	...
	if ($save_type == 'upload') {
		...
		foreach ($options as $option_array) {
			...
			if (isset($option_array['id'])) {
				...
				// ..fonts
					...
					$fonts_content[] = $output[$id . '_font_face'] . ':300,400,700';;
		...
		$fonts_content_str = '@import url(\'https://fonts.googleapis.com/css?family=' . implode('|', $fonts_content) . '&subset=' . $font_subsets . '\');';
		create_google_css(TEMPLATEPATH . '/css/gfonts.css', $fonts_content_str);
	}
