...
model = LSTM(n_feature=n_feature, n_past=n_past, n_future=1, n_layers=8, dim_model=512, dim_embed=256, dropout=0.1)
model.to(device)
...
for epoch in range(start_epoch, epochs):
    ...
    data_path = os.path.join(os.getcwd(), "data", "figure_smd_lstm")
